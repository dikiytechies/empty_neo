...
public interface ClientGamePacketListener extends ClientPongPacketListener, ClientCommonPacketListener {
    ...
    void handleRecipeBookAdd(ClientboundRecipeBookAddPacket p_380093_);

    void handleRecipeBookRemove(ClientboundRecipeBookRemovePacket p_380197_);

    void handleRecipeBookSettings(ClientboundRecipeBookSettingsPacket p_379829_);
    ...
    void handleMinecartAlongTrack(ClientboundMoveMinecartPacket p_362353_);

    void handleMovePlayer(ClientboundPlayerPositionPacket p_131416_);

    void handleRotatePlayer(ClientboundPlayerRotationPacket p_380285_);
    ...
    void handleSetHeldSlot(ClientboundSetHeldSlotPacket p_361915_);
    ...
    void handleEntityPositionSync(ClientboundEntityPositionSyncPacket p_379541_);
    ...
    void handleSetCursorItem(ClientboundSetCursorItemPacket p_361508_);

    void handleSetPlayerInventory(ClientboundSetPlayerInventoryPacket p_362357_);
}
