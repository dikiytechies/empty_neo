...
public record ClientboundMoveVehiclePacket(Vec3 position, float yRot, float xRot) implements Packet<ClientGamePacketListener> {
    ...
    public static ClientboundMoveVehiclePacket fromEntity(Entity p_387934_) {
        return new ClientboundMoveVehiclePacket(p_387934_.position(), p_387934_.getYRot(), p_387934_.getXRot());
    }
