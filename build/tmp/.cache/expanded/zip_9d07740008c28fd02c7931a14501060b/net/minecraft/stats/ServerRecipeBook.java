...
public class ServerRecipeBook extends RecipeBook {
    ...
    public ServerRecipeBook(ServerRecipeBook.DisplayResolver p_380166_) {
    ...
    public void fromNbt(CompoundTag p_12795_, Predicate<ResourceKey<Recipe<?>>> p_379369_) {
        ...
        this.loadRecipes(listtag, this::add, p_379369_);
        ListTag listtag1 = p_12795_.getList("toBeDisplayed", 8);
        this.loadRecipes(listtag1, this::addHighlight, p_379369_);
    }
    ...
    public interface DisplayResolver {
        void displaysForRecipe(ResourceKey<Recipe<?>> p_380132_, Consumer<RecipeDisplayEntry> p_380289_);
    }
}
