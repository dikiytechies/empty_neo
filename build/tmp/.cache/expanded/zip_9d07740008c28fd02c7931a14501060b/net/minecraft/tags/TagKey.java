...
public record TagKey<T>(ResourceKey<? extends Registry<T>> registry, ResourceLocation location) {
    ...
    public static <T> StreamCodec<ByteBuf, TagKey<T>> streamCodec(ResourceKey<? extends Registry<T>> p_372956_) {
        return ResourceLocation.STREAM_CODEC.map(p_372701_ -> create(p_372956_, p_372701_), TagKey::location);
    }
