...
public final class DataComponentPredicate implements Predicate<DataComponentMap> {
    ...
    public static DataComponentPredicate someOf(DataComponentMap p_371678_, DataComponentType<?>... p_371329_) {
        ...
        for (DataComponentType<?> datacomponenttype : p_371329_) {
            TypedDataComponent<?> typeddatacomponent = p_371678_.getTyped(datacomponenttype);
    ...
    public static class Builder {
        ...
        public <T> DataComponentPredicate.Builder expect(TypedDataComponent<T> p_371914_) {
