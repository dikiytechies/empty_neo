...
public class CarvingStepRemoveFix extends DataFix {
    public CarvingStepRemoveFix(Schema p_361963_) {
        super(p_361963_, false);
    }
    ...
    private static Typed<?> fixChunk(Typed<?> p_360286_) {
        return p_360286_.update(DSL.remainderFinder(), p_362371_ -> {
