...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    public VanillaBlockLoot(HolderLookup.Provider p_344962_) {
        super(EXPLOSION_RESISTANT, FeatureFlags.REGISTRY.allFlags(), p_344962_);
    }
    ...
    protected void generate() {
        ...
        this.add(Blocks.PALE_HANGING_MOSS, p_382574_ -> this.createShearsOrSilkTouchOnlyDrop(p_382574_));
        ...
        this.add(Blocks.OAK_DOOR, p_382607_ -> this.createDoorTable(p_382607_));
        this.add(Blocks.SPRUCE_DOOR, p_382617_ -> this.createDoorTable(p_382617_));
        this.add(Blocks.BIRCH_DOOR, p_382602_ -> this.createDoorTable(p_382602_));
        this.add(Blocks.JUNGLE_DOOR, p_382623_ -> this.createDoorTable(p_382623_));
        this.add(Blocks.ACACIA_DOOR, p_382600_ -> this.createDoorTable(p_382600_));
        this.add(Blocks.DARK_OAK_DOOR, p_382596_ -> this.createDoorTable(p_382596_));
        this.add(Blocks.PALE_OAK_DOOR, p_382584_ -> this.createDoorTable(p_382584_));
        this.add(Blocks.MANGROVE_DOOR, p_382639_ -> this.createDoorTable(p_382639_));
        this.add(Blocks.CHERRY_DOOR, p_382637_ -> this.createDoorTable(p_382637_));
        this.add(Blocks.BAMBOO_DOOR, p_382629_ -> this.createDoorTable(p_382629_));
        this.add(Blocks.WARPED_DOOR, p_382613_ -> this.createDoorTable(p_382613_));
        this.add(Blocks.CRIMSON_DOOR, p_382586_ -> this.createDoorTable(p_382586_));
        this.add(Blocks.IRON_DOOR, p_382572_ -> this.createDoorTable(p_382572_));
        this.add(Blocks.COPPER_DOOR, p_382641_ -> this.createDoorTable(p_382641_));
        this.add(Blocks.EXPOSED_COPPER_DOOR, p_382643_ -> this.createDoorTable(p_382643_));
        this.add(Blocks.WEATHERED_COPPER_DOOR, p_382609_ -> this.createDoorTable(p_382609_));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, p_382564_ -> this.createDoorTable(p_382564_));
        this.add(Blocks.WAXED_COPPER_DOOR, p_382580_ -> this.createDoorTable(p_382580_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, p_382566_ -> this.createDoorTable(p_382566_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, p_382625_ -> this.createDoorTable(p_382625_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, p_382604_ -> this.createDoorTable(p_382604_));
