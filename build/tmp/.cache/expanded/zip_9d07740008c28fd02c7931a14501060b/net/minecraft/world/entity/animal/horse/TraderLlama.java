...
public class TraderLlama extends Llama {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector
            .addGoal(
                2, new NearestAttackableTargetGoal<>(this, Zombie.class, true, (p_375853_, p_375854_) -> p_375853_.getType() != EntityType.ZOMBIFIED_PIGLIN)
            );
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_30942_, DifficultyInstance p_30943_, EntitySpawnReason p_364324_, @Nullable SpawnGroupData p_30945_
    ) {
        if (p_364324_ == EntitySpawnReason.EVENT) {
            this.setAge(0);
        }
        ...
        return super.finalizeSpawn(p_30942_, p_30943_, p_364324_, p_30945_);
    }
