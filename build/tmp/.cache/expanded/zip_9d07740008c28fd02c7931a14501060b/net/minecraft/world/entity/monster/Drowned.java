...
public class Drowned extends Zombie implements RangedAttackMob {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_32372_, DifficultyInstance p_32373_, EntitySpawnReason p_365099_, @Nullable SpawnGroupData p_32375_
    ) {
        p_32375_ = super.finalizeSpawn(p_32372_, p_32373_, p_365099_, p_32375_);
    ...
    public static boolean checkDrownedSpawnRules(
        EntityType<Drowned> p_218956_, ServerLevelAccessor p_218957_, EntitySpawnReason p_360945_, BlockPos p_218959_, RandomSource p_218960_
    ) {
        if (!p_218957_.getFluidState(p_218959_.below()).is(FluidTags.WATER) && !EntitySpawnReason.isSpawner(p_360945_)) {
            return false;
        } else {
            Holder<Biome> holder = p_218957_.getBiome(p_218959_);
            boolean flag = p_218957_.getDifficulty() != Difficulty.PEACEFUL
                && (EntitySpawnReason.ignoresLightRequirements(p_360945_) || isDarkEnoughToSpawn(p_218957_, p_218959_, p_218960_))
                && (EntitySpawnReason.isSpawner(p_360945_) || p_218957_.getFluidState(p_218959_).is(FluidTags.WATER));
            if (!flag || !EntitySpawnReason.isSpawner(p_360945_) && p_360945_ != EntitySpawnReason.REINFORCEMENT) {
    ...
    @Override
    protected boolean canReplaceCurrentItem(ItemStack p_32364_, ItemStack p_32365_, EquipmentSlot p_371339_) {
        return p_32365_.is(Items.NAUTILUS_SHELL) ? false : super.canReplaceCurrentItem(p_32364_, p_32365_, p_371339_);
    }
    ...
    public void performRangedAttack(LivingEntity p_32356_, float p_32357_) {
        ...
        if (this.level() instanceof ServerLevel serverlevel) {
            Projectile.spawnProjectileUsingShoot(
                throwntrident, serverlevel, itemstack1, d0, d1 + d3 * 0.2F, d2, 1.6F, (float)(14 - this.level().getDifficulty().getId() * 4)
            );
        }
