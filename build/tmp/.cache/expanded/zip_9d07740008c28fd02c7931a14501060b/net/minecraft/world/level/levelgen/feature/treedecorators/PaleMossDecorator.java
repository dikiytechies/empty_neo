...
public class PaleMossDecorator extends TreeDecorator {
    ...
    private static void addMossHanger(BlockPos p_379694_, TreeDecorator.Context p_379973_) {
        while (p_379973_.isAir(p_379694_.below()) && !((double)p_379973_.random().nextFloat() < 0.5)) {
            p_379973_.setBlock(p_379694_, Blocks.PALE_HANGING_MOSS.defaultBlockState().setValue(HangingMossBlock.TIP, Boolean.valueOf(false)));
            p_379694_ = p_379694_.below();
        }

        p_379973_.setBlock(p_379694_, Blocks.PALE_HANGING_MOSS.defaultBlockState().setValue(HangingMossBlock.TIP, Boolean.valueOf(true)));
    }
}
