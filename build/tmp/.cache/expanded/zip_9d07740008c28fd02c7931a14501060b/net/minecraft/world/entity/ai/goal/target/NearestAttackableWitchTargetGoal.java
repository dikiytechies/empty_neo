...
public class NearestAttackableWitchTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    ...
    public NearestAttackableWitchTargetGoal(
        Raider p_26076_, Class<T> p_26077_, int p_26078_, boolean p_26079_, boolean p_26080_, @Nullable TargetingConditions.Selector p_376279_
    ) {
        super(p_26076_, p_26077_, p_26078_, p_26079_, p_26080_, p_376279_);
    }
