...
public abstract class ThrowableItemProjectile extends ThrowableProjectile implements ItemSupplier {
    ...
    public ThrowableItemProjectile(
        EntityType<? extends ThrowableItemProjectile> p_37432_, double p_37433_, double p_37434_, double p_37435_, Level p_37436_, ItemStack p_365049_
    ) {
        super(p_37432_, p_37433_, p_37434_, p_37435_, p_37436_);
        this.setItem(p_365049_);
    }

    public ThrowableItemProjectile(EntityType<? extends ThrowableItemProjectile> p_37438_, LivingEntity p_37439_, Level p_37440_, ItemStack p_363259_) {
        this(p_37438_, p_37439_.getX(), p_37439_.getEyeY() - 0.1F, p_37439_.getZ(), p_37440_, p_363259_);
