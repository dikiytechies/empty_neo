...
public class Guardian extends Monster {
    ...
    public static boolean checkGuardianSpawnRules(
        EntityType<? extends Guardian> p_218991_, LevelAccessor p_218992_, EntitySpawnReason p_363756_, BlockPos p_218994_, RandomSource p_218995_
    ) {
        return (p_218995_.nextInt(20) == 0 || !p_218992_.canSeeSkyFromBelowWater(p_218994_))
            && p_218992_.getDifficulty() != Difficulty.PEACEFUL
            && (EntitySpawnReason.isSpawner(p_363756_) || p_218992_.getFluidState(p_218994_).is(FluidTags.WATER))
