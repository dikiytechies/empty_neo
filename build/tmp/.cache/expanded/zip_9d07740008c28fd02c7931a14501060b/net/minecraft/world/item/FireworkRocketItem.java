...
public class FireworkRocketItem extends Item implements ProjectileItem {
    ...
    private static Vec3 getEntityJustOutsideOfBlockPos(BlockSource p_371687_, Direction p_371656_) {
        return p_371687_.center()
            .add(
                (double)p_371656_.getStepX() * 0.5000099999997474,
                (double)p_371656_.getStepY() * 0.5000099999997474,
                (double)p_371656_.getStepZ() * 0.5000099999997474
            );
    }
}
