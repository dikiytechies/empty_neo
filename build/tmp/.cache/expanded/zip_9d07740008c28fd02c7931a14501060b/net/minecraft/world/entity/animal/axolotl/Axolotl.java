...
public class Axolotl extends Animal implements VariantHolder<Axolotl.Variant>, Bucketable {
    ...
    public boolean hurtServer(ServerLevel p_376765_, DamageSource p_376159_, float p_376250_) {
        ...
        if (!this.isNoAi()
            ...
            && ((float)this.level().random.nextInt(3) < p_376250_ || f / this.getMaxHealth() < 0.5F)
            && p_376250_ < f
            && this.isInWater()
    ...
    public void saveToBucketTag(ItemStack p_149187_) {
        ...
        CustomData.update(DataComponents.BUCKET_ENTITY_DATA, p_149187_, p_386316_ -> {
            p_386316_.putInt("Variant", this.getVariant().getId());
            p_386316_.putInt("Age", this.getAge());
            Brain<?> brain = this.getBrain();
            if (brain.hasMemoryValue(MemoryModuleType.HAS_HUNTING_COOLDOWN)) {
                p_386316_.putLong("HuntingCooldown", brain.getTimeUntilExpiry(MemoryModuleType.HAS_HUNTING_COOLDOWN));
            }
        });
    }
    ...
    public static void onStopAttacking(ServerLevel p_376262_, Axolotl p_218444_, LivingEntity p_218445_) {
        if (p_218445_.isDeadOrDying()) {
            ...
            if (damagesource != null) {
                ...
                if (entity != null && entity.getType() == EntityType.PLAYER) {
                    ...
                    List<Player> list = p_376262_.getEntitiesOfClass(Player.class, p_218444_.getBoundingBox().inflate(20.0));
