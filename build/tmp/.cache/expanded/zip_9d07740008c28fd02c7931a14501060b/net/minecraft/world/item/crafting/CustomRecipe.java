...
public abstract class CustomRecipe implements CraftingRecipe {
    ...
    public static class Serializer<T extends CraftingRecipe> implements RecipeSerializer<T> {
        ...
        public Serializer(CustomRecipe.Serializer.Factory<T> p_379849_) {
            this.codec = RecordCodecBuilder.mapCodec(
                p_380388_ -> p_380388_.group(
                            CraftingBookCategory.CODEC.fieldOf("category").orElse(CraftingBookCategory.MISC).forGetter(CraftingRecipe::category)
                        )
                        .apply(p_380388_, p_379849_::create)
            );
            this.streamCodec = StreamCodec.composite(CraftingBookCategory.STREAM_CODEC, CraftingRecipe::category, p_379849_::create);
        }
        ...
        public interface Factory<T extends CraftingRecipe> {
            T create(CraftingBookCategory p_380052_);
        }
    }
}
