...
public class PoiSection {
    ...
    public static record Packed(boolean isValid, List<PoiRecord.Packed> records) {
        ...
        public PoiSection unpack(Runnable p_364435_) {
            return new PoiSection(p_364435_, this.isValid, this.records.stream().map(p_364973_ -> p_364973_.unpack(p_364435_)).toList());
        }
    }
}
