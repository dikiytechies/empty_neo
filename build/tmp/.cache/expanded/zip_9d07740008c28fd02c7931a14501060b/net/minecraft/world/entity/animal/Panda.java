...
public class Panda extends Animal {
    ...
    protected boolean canDispenserEquipIntoSlot(EquipmentSlot p_371896_) {
        return p_371896_ == EquipmentSlot.MAINHAND && this.canPickUpLoot();
    }
    ...
    public boolean doHurtTarget(ServerLevel p_376520_, Entity p_29091_) {
        ...
        return super.doHurtTarget(p_376520_, p_29091_);
    }
    ...
    public boolean hurtServer(ServerLevel p_376309_, DamageSource p_376843_, float p_376403_) {
        this.sit(false);
        return super.hurtServer(p_376309_, p_376843_, p_376403_);
    }

    @Nullable
    @Override
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_29109_, DifficultyInstance p_29110_, EntitySpawnReason p_365266_, @Nullable SpawnGroupData p_29112_
    ) {
        ...
        return super.finalizeSpawn(p_29109_, p_29110_, p_365266_, p_29112_);
    }
    ...
    private static boolean canPickUpAndEat(ItemEntity p_372991_) {
        return p_372991_.getItem().is(ItemTags.PANDA_EATS_FROM_GROUND) && p_372991_.isAlive() && !p_372991_.hasPickUpDelay();
    }
