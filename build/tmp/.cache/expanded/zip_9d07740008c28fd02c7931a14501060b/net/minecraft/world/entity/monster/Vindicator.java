...
public class Vindicator extends AbstractIllager {
    ...
    @Override
    protected void customServerAiStep(ServerLevel p_376840_) {
        if (!this.isNoAi() && GoalUtils.hasGroundPathNavigation(this)) {
            boolean flag = p_376840_.isRaided(this.blockPosition());
            ((GroundPathNavigation)this.getNavigation()).setCanOpenDoors(flag);
        }

        super.customServerAiStep(p_376840_);
    }
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_34088_, DifficultyInstance p_34089_, EntitySpawnReason p_362629_, @Nullable SpawnGroupData p_34091_
    ) {
        SpawnGroupData spawngroupdata = super.finalizeSpawn(p_34088_, p_34089_, p_362629_, p_34091_);
    ...
    static class VindicatorJohnnyAttackGoal extends NearestAttackableTargetGoal<LivingEntity> {
        public VindicatorJohnnyAttackGoal(Vindicator p_34117_) {
            super(p_34117_, LivingEntity.class, 0, true, true, (p_376548_, p_376728_) -> p_376548_.attackable());
        }
