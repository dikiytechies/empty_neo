...
public class BuiltInLootTables {
    ...
    public static final Map<DyeColor, ResourceKey<LootTable>> SHEEP_BY_DYE = Util.make(
        new EnumMap<>(DyeColor.class), p_365508_ -> makeDyeKeyMap((EnumMap<DyeColor, ResourceKey<LootTable>>)p_365508_, "entities/sheep")
    );
    ...
    public static final Map<DyeColor, ResourceKey<LootTable>> SHEAR_SHEEP_BY_DYE = Util.make(
        new EnumMap<>(DyeColor.class), p_365078_ -> makeDyeKeyMap((EnumMap<DyeColor, ResourceKey<LootTable>>)p_365078_, "shearing/sheep")
    );
    ...
    private static void makeDyeKeyMap(EnumMap<DyeColor, ResourceKey<LootTable>> p_360918_, String p_363301_) {
        for (DyeColor dyecolor : DyeColor.values()) {
            p_360918_.put(dyecolor, register(p_363301_ + "/" + dyecolor.getName()));
        }
    }
