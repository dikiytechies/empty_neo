...
public class PaintingVariants {
    ...
    public static void bootstrap(BootstrapContext<PaintingVariant> p_345677_) {
        ...
        register(p_345677_, WITHER, 2, 2, false);
        ...
        register(p_345677_, EARTH, 2, 2, false);
        register(p_345677_, WIND, 2, 2, false);
        register(p_345677_, WATER, 2, 2, false);
        register(p_345677_, FIRE, 2, 2, false);
