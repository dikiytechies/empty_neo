...
public class RecipeBookCategories {
    ...
    private static RecipeBookCategory register(String p_380980_) {
        return Registry.register(BuiltInRegistries.RECIPE_BOOK_CATEGORY, p_380980_, new RecipeBookCategory());
    }

    public static RecipeBookCategory bootstrap(Registry<RecipeBookCategory> p_381090_) {
        return CAMPFIRE;
    }
}
