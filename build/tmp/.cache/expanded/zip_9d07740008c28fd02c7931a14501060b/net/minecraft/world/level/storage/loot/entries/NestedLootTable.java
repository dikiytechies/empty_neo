    ...
    public void validate(ValidationContext p_330583_) {
        ...
        if (optional.isPresent()) {
            ...
            if (!p_330583_.allowsReferences()) {
                p_330583_.reportProblem("Uses reference to " + resourcekey.location() + ", but references are not allowed");
                return;
            }
        ...
        this.contents
            .ifLeft(
                p_368484_ -> p_330583_.resolver()
                        ...
                        .ifPresentOrElse(
                            p_339565_ -> p_339565_.value().validate(p_330583_.enterElement("->{" + p_368484_.location() + "}", (ResourceKey<?>)p_368484_)),
                            () -> p_330583_.reportProblem("Unknown loot table called " + p_368484_.location())
                        )
            )
