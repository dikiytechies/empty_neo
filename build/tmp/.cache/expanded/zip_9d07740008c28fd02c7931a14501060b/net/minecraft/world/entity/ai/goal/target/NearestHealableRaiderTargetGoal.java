...
public class NearestHealableRaiderTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    ...
    public NearestHealableRaiderTargetGoal(Raider p_26087_, Class<T> p_26088_, boolean p_26089_, @Nullable TargetingConditions.Selector p_376889_) {
        super(p_26087_, p_26088_, 500, p_26089_, false, p_376889_);
    }
