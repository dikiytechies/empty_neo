...
public record RecipeDisplayEntry(
    ...
    public List<ItemStack> resultItems(ContextMap p_381045_) {
        return this.display.result().resolveForStacks(p_381045_);
    }

    public boolean canCraft(StackedItemContents p_379995_) {
        return this.craftingRequirements.isEmpty() ? false : p_379995_.canCraft(this.craftingRequirements.get(), null);
    }
}
