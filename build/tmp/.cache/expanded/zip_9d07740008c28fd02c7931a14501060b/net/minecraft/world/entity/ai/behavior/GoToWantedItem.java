        ...
        return BehaviorBuilder.create(
            p_258371_ -> {
                ...
                return p_258371_.group(
                    ...
                    .apply(
                        p_258371_,
                        (p_258387_, p_258388_, p_258389_, p_258390_) -> (p_367935_, p_367936_, p_367937_) -> {
                                ItemEntity itementity = p_258371_.get(p_258389_);
                                if (p_258371_.tryGet(p_258390_).isEmpty()
                                    && p_259490_.test(p_367936_)
                                    && itementity.closerThan(p_367936_, (double)p_259054_)
                                    && p_367936_.level().getWorldBorder().isWithinBounds(itementity.blockPosition())
                                    && p_367936_.canPickUpLoot()) {
