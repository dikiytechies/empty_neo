...
public class TargetingConditions {
    ...
    public TargetingConditions selector(@Nullable TargetingConditions.Selector p_376314_) {
    ...
    public boolean test(ServerLevel p_376690_, @Nullable LivingEntity p_26886_, LivingEntity p_26887_) {
        if (p_26886_ == p_26887_) {
            ...
            return false;
        } else if (this.selector != null && !this.selector.test(p_26887_, p_376690_)) {
            return false;
        } else {
            if (p_26886_ == null) {
    ...
    public interface Selector {
        boolean test(LivingEntity p_376107_, ServerLevel p_376747_);
    }
}
