...
public class SkeletonHorse extends AbstractHorse {
    ...
    public static boolean checkSkeletonHorseSpawnRules(
        EntityType<? extends Animal> p_312143_, LevelAccessor p_312574_, EntitySpawnReason p_364141_, BlockPos p_312362_, RandomSource p_312555_
    ) {
        return !EntitySpawnReason.isSpawner(p_364141_)
            ? Animal.checkAnimalSpawnRules(p_312143_, p_312574_, p_364141_, p_312362_, p_312555_)
            : EntitySpawnReason.ignoresLightRequirements(p_364141_) || isBrightEnoughToSpawn(p_312574_, p_312362_);
    }
