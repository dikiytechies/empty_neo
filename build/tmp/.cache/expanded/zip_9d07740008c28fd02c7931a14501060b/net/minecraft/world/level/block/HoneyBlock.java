...
public class HoneyBlock extends HalfTransparentBlock {
    ...
    private static double getOldDeltaY(double p_381724_) {
        return p_381724_ / 0.98F + 0.08;
    }

    private static double getNewDeltaY(double p_381725_) {
        return (p_381725_ - 0.08) * 0.98F;
    }
