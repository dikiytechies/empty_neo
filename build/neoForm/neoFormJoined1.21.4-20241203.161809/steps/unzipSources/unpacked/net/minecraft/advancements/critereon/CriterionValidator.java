...
public class CriterionValidator {
    ...
    public void validate(ContextAwarePredicate p_312318_, ContextKeySet p_381036_, String p_312401_) {
        p_312318_.validate(new ValidationContext(this.reporter.forChild(p_312401_), p_381036_, this.lootData));
    }

    public void validate(List<ContextAwarePredicate> p_312108_, ContextKeySet p_381078_, String p_312670_) {
        for (int i = 0; i < p_312108_.size(); i++) {
            ContextAwarePredicate contextawarepredicate = p_312108_.get(i);
            contextawarepredicate.validate(new ValidationContext(this.reporter.forChild(p_312670_ + "[" + i + "]"), p_381078_, this.lootData));
        }
    }
}
