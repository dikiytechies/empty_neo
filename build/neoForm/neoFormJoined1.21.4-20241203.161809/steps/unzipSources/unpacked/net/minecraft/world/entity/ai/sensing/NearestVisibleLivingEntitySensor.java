...
public abstract class NearestVisibleLivingEntitySensor extends Sensor<LivingEntity> {
    protected abstract boolean isMatchingEntity(ServerLevel p_376187_, LivingEntity p_148292_, LivingEntity p_148293_);
    ...
    private Optional<LivingEntity> getNearestEntity(ServerLevel p_376249_, LivingEntity p_148298_) {
        return this.getVisibleEntities(p_148298_)
            .flatMap(p_375751_ -> p_375751_.findClosest(p_375748_ -> this.isMatchingEntity(p_376249_, p_148298_, p_375748_)));
    }
