...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(
            (p_379166_, p_379167_) -> !p_379166_.getType().equals(EntityType.GOAT)
                    && (!p_379167_.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) || !p_379166_.getType().equals(EntityType.ARMOR_STAND))
                    && p_379167_.getWorldBorder().isWithinBounds(p_379166_.getBoundingBox())
        );
    ...
    private static void initCoreActivity(Brain<Goat> p_149454_) {
        p_149454_.addActivity(
            Activity.CORE,
            0,
            ImmutableList.<net.minecraft.world.entity.ai.behavior.BehaviorControl<? super Goat>>of(
                new Swim<>(0.8F),
            ...
            ImmutableList.of(
                Pair.of(
                    ...
                    new RamTarget(
                        ...
                        3.0F,
                        p_375848_ -> p_375848_.isBaby() ? 1.0 : 2.5,
