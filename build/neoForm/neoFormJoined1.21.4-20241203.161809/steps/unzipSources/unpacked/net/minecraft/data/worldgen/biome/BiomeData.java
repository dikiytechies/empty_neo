...
public abstract class BiomeData {
    public static void bootstrap(BootstrapContext<Biome> p_321862_) {
        ...
        p_321862_.register(Biomes.SWAMP, OverworldBiomes.swamp(holdergetter, holdergetter1));
        p_321862_.register(Biomes.MANGROVE_SWAMP, OverworldBiomes.mangroveSwamp(holdergetter, holdergetter1));
        ...
        p_321862_.register(Biomes.DARK_FOREST, OverworldBiomes.darkForest(holdergetter, holdergetter1, false));
        p_321862_.register(Biomes.PALE_GARDEN, OverworldBiomes.darkForest(holdergetter, holdergetter1, true));
