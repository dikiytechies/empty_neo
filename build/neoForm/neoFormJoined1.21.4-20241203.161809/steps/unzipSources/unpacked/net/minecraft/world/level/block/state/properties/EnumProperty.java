...
public final class EnumProperty<T extends Enum<T> & StringRepresentable> extends Property<T> {
    ...
    public static <T extends Enum<T> & StringRepresentable> EnumProperty<T> create(String p_61591_, Class<T> p_61592_, List<T> p_372944_) {
        return new EnumProperty<>(p_61591_, p_61592_, p_372944_);
    }
}
