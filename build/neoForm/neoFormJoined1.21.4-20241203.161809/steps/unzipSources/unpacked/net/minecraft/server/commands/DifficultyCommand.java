...
public class DifficultyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_136939_) {
        ...
        p_136939_.register(literalargumentbuilder.requires(p_136943_ -> p_136943_.hasPermission(2)).executes(p_382673_ -> {
            Difficulty difficulty1 = p_382673_.getSource().getLevel().getDifficulty();
            p_382673_.getSource().sendSuccess(() -> Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
