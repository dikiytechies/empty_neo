...
public abstract class AbstractSchoolingFish extends AbstractFish {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_27528_, DifficultyInstance p_27529_, EntitySpawnReason p_360900_, @Nullable SpawnGroupData p_27531_
    ) {
        super.finalizeSpawn(p_27528_, p_27529_, p_360900_, p_27531_);
        if (p_27531_ == null) {
