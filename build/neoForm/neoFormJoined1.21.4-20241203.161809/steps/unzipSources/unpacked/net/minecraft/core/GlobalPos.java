...
public record GlobalPos(ResourceKey<Level> dimension, BlockPos pos) {
    ...
    public boolean isCloseEnough(ResourceKey<Level> p_381737_, BlockPos p_381740_, int p_381738_) {
        return this.dimension.equals(p_381737_) && this.pos.distChessboard(p_381740_) <= p_381738_;
    }
}
