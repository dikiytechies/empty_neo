...
public class ArmorStand extends LivingEntity {
    ...
    private static final Predicate<Entity> RIDABLE_MINECARTS = p_373856_ -> {
        if (p_373856_ instanceof AbstractMinecart abstractminecart && abstractminecart.isRideable()) {
            return true;
        }
    ...
    public boolean canUseSlot(EquipmentSlot p_326077_) {
        return p_326077_ != EquipmentSlot.BODY && !this.isDisabled(p_326077_);
    }
    ...
    public boolean hurtServer(ServerLevel p_376183_, DamageSource p_31579_, float p_31580_) {
        if (this.isRemoved()) {
            return false;
        } else if (!p_376183_.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && p_31579_.getEntity() instanceof Mob) {
            return false;
