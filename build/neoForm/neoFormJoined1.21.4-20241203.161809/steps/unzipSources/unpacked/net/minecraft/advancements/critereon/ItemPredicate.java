...
public record ItemPredicate(
    ...
    public static class Builder {
        ...
        public ItemPredicate.Builder of(HolderGetter<Item> p_362255_, ItemLike... p_151446_) {
            this.items = Optional.of(HolderSet.direct(p_298756_ -> p_298756_.asItem().builtInRegistryHolder(), p_151446_));
            return this;
        }

        public ItemPredicate.Builder of(HolderGetter<Item> p_361675_, TagKey<Item> p_204146_) {
            this.items = Optional.of(p_361675_.getOrThrow(p_204146_));
            return this;
        }
