...
public record Tool(List<Tool.Rule> rules, float defaultMiningSpeed, int damagePerBlock) {
    ...
    public static record Rule(HolderSet<Block> blocks, Optional<Float> speed, Optional<Boolean> correctForDrops) {
        ...
        public static Tool.Rule minesAndDrops(HolderSet<Block> p_360797_, float p_335923_) {
            return new Tool.Rule(p_360797_, Optional.of(p_335923_), Optional.of(true));
        }

        public static Tool.Rule deniesDrops(HolderSet<Block> p_361384_) {
            return new Tool.Rule(p_361384_, Optional.empty(), Optional.of(false));
        }

        public static Tool.Rule overrideSpeed(HolderSet<Block> p_362775_, float p_335857_) {
            return new Tool.Rule(p_362775_, Optional.of(p_335857_), Optional.empty());
        }
    }
}
