...
public class StonecutterMenu extends AbstractContainerMenu {
    ...
    void setupResultSlot(int p_379442_) {
        Optional<RecipeHolder<StonecutterRecipe>> optional;
        if (!this.recipesForInput.isEmpty() && this.isValidRecipeIndex(p_379442_)) {
            SelectableRecipe.SingleInputEntry<StonecutterRecipe> singleinputentry = this.recipesForInput.entries().get(p_379442_);
