...
public abstract class WaterAnimal extends PathfinderMob {
    ...
    @Override
    protected int getBaseExperienceReward(ServerLevel p_376158_) {
    ...
    public static boolean checkSurfaceWaterAnimalSpawnRules(
        EntityType<? extends WaterAnimal> p_218283_, LevelAccessor p_218284_, EntitySpawnReason p_362406_, BlockPos p_218286_, RandomSource p_218287_
    ) {
