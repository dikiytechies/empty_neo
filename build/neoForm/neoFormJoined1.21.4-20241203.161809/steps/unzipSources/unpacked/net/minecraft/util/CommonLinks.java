...
public class CommonLinks {
    ...
    public static String extendRealms(@Nullable String p_276321_, UUID p_295484_, boolean p_276266_) {
        return p_276321_ == null
            ? "https://aka.ms/ExtendJavaRealms"
            : extendRealms(p_276321_, p_295484_) + "&ref=" + (p_276266_ ? "expiredTrial" : "expiredRealm");
    }

    public static String extendRealms(@Nullable String p_276318_, UUID p_296140_) {
        return p_276318_ == null
            ? "https://aka.ms/ExtendJavaRealms"
            : "https://aka.ms/ExtendJavaRealms?subscriptionId=" + p_276318_ + "&profileId=" + UndashedUuid.toString(p_296140_);
    }
}
