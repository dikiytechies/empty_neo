...
public class ZombieHorse extends AbstractHorse {
    ...
    public static boolean checkZombieHorseSpawnRules(
        ...
        return !EntitySpawnReason.isSpawner(p_364610_)
            ? Animal.checkAnimalSpawnRules(p_312450_, p_312340_, p_364610_, p_311838_, p_312514_)
            : EntitySpawnReason.ignoresLightRequirements(p_364610_) || isBrightEnoughToSpawn(p_312340_, p_311838_);
    }
