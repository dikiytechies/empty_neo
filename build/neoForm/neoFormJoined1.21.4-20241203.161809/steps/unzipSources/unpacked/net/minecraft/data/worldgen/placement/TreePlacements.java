...
public class TreePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> p_321763_) {
        ...
        PlacementUtils.register(p_321763_, PALE_OAK_CHECKED, holder4, PlacementUtils.filteredByBlockSurvival(Blocks.PALE_OAK_SAPLING));
        PlacementUtils.register(p_321763_, PALE_OAK_CREAKING_CHECKED, holder5, PlacementUtils.filteredByBlockSurvival(Blocks.PALE_OAK_SAPLING));
        PlacementUtils.register(p_321763_, BIRCH_CHECKED, holder6, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(p_321763_, ACACIA_CHECKED, holder7, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
        PlacementUtils.register(p_321763_, SPRUCE_CHECKED, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(p_321763_, MANGROVE_CHECKED, holder9, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
        PlacementUtils.register(p_321763_, CHERRY_CHECKED, holder10, PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING));
        ...
        PlacementUtils.register(p_321763_, PINE_ON_SNOW, holder11, list);
        PlacementUtils.register(p_321763_, SPRUCE_ON_SNOW, holder8, list);
        PlacementUtils.register(p_321763_, PINE_CHECKED, holder11, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(p_321763_, JUNGLE_TREE_CHECKED, holder12, PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING));
        PlacementUtils.register(p_321763_, FANCY_OAK_CHECKED, holder13, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, MEGA_JUNGLE_TREE_CHECKED, holder14, PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING));
        PlacementUtils.register(p_321763_, MEGA_SPRUCE_CHECKED, holder15, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(p_321763_, MEGA_PINE_CHECKED, holder16, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(p_321763_, TALL_MANGROVE_CHECKED, holder17, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
        PlacementUtils.register(p_321763_, JUNGLE_BUSH, holder18, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, SUPER_BIRCH_BEES_0002, holder19, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(p_321763_, SUPER_BIRCH_BEES, holder20, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(p_321763_, OAK_BEES_0002, holder21, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, OAK_BEES_002, holder22, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, BIRCH_BEES_0002_PLACED, holder23, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(p_321763_, BIRCH_BEES_002, holder24, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(p_321763_, FANCY_OAK_BEES_0002, holder25, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, FANCY_OAK_BEES_002, holder26, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, FANCY_OAK_BEES, holder27, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(p_321763_, CHERRY_BEES_005, holder28, PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING));
    }
}
