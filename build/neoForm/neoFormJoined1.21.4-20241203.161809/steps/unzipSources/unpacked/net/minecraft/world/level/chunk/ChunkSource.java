...
public abstract class ChunkSource implements LightChunkGetter, AutoCloseable {
    ...
    @Nullable
    public abstract ChunkAccess getChunk(int p_62223_, int p_62224_, ChunkStatus p_330657_, boolean p_62226_);

    public abstract void tick(BooleanSupplier p_202162_, boolean p_202163_);

    public void onSectionEmptinessChanged(int p_366795_, int p_366481_, int p_366587_, boolean p_366495_) {
    }
