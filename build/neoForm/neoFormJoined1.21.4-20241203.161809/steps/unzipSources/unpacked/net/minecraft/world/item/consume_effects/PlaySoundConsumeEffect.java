...
public record PlaySoundConsumeEffect(Holder<SoundEvent> sound) implements ConsumeEffect {
    ...
    @Override
    public boolean apply(Level p_366628_, ItemStack p_366717_, LivingEntity p_366700_) {
        p_366628_.playSound(null, p_366700_.blockPosition(), this.sound.value(), p_366700_.getSoundSource(), 1.0F, 1.0F);
        return true;
    }
}
