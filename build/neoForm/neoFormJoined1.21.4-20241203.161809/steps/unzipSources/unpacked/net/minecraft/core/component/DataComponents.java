...
public class DataComponents {
    ...
    public static final DataComponentType<Unit> GLIDER = register(
        "glider", p_344190_ -> p_344190_.persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE))
    );
    ...
    public static final DataComponentType<List<ResourceKey<Recipe<?>>>> RECIPES = register(
        "recipes", p_378841_ -> p_378841_.persistent(ResourceKey.codec(Registries.RECIPE).listOf()).cacheEncoding()
    );
