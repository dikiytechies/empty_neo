...
public class PolarBear extends Animal implements NeutralMob {
    ...
    public static boolean checkPolarBearSpawnRules(
        EntityType<PolarBear> p_218250_, LevelAccessor p_218251_, EntitySpawnReason p_361507_, BlockPos p_218253_, RandomSource p_218254_
    ) {
        Holder<Biome> holder = p_218251_.getBiome(p_218253_);
        return !holder.is(BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS)
            ? checkAnimalSpawnRules(p_218250_, p_218251_, p_361507_, p_218253_, p_218254_)
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_29533_, DifficultyInstance p_29534_, EntitySpawnReason p_361358_, @Nullable SpawnGroupData p_29536_
    ) {
        if (p_29536_ == null) {
