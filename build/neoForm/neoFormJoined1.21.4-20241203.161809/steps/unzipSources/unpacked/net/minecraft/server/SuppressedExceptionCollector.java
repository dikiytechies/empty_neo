...
public class SuppressedExceptionCollector {
    ...
    public synchronized void addEntry(String p_363905_, Throwable p_364135_) {
        ...
        this.latestEntries.add(new SuppressedExceptionCollector.LongEntry(i, p_363905_, (Class<? extends Throwable>)p_364135_.getClass(), s));
        ...
        SuppressedExceptionCollector.ShortEntry suppressedexceptioncollector$shortentry = new SuppressedExceptionCollector.ShortEntry(
            p_363905_, (Class<? extends Throwable>)p_364135_.getClass()
        );
