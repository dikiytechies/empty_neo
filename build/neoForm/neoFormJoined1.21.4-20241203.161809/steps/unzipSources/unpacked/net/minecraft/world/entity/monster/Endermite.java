...
public class Endermite extends Monster {
    ...
    public static boolean checkEndermiteSpawnRules(
        EntityType<Endermite> p_218969_, LevelAccessor p_218970_, EntitySpawnReason p_363979_, BlockPos p_218972_, RandomSource p_218973_
    ) {
        if (!checkAnyLightMonsterSpawnRules(p_218969_, p_218970_, p_363979_, p_218972_, p_218973_)) {
            return false;
        } else if (EntitySpawnReason.isSpawner(p_363979_)) {
            return true;
        } else {
