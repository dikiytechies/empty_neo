...
public class WardenAi {
        ...
        p_219519_.addActivityAndRemoveMemoryWhenStopped(
            ...
            ImmutableList.of(
                ...
                StopAttackingIfTargetInvalid.<Warden>create(
                    (p_376299_, p_219540_) -> !p_219518_.getAngerLevel().isAngry() || !p_219518_.canTargetEntity(p_219540_), WardenAi::onTargetInvalid, false
                ),
    ...
    private static void onTargetInvalid(ServerLevel p_376213_, Warden p_219529_, LivingEntity p_219530_) {
