...
public record TrimPattern(ResourceLocation assetId, Holder<Item> templateItem, Component description, boolean decal) {
    public static final Codec<TrimPattern> DIRECT_CODEC = RecordCodecBuilder.create(
        p_381598_ -> p_381598_.group(
                ...
                .apply(p_381598_, TrimPattern::new)
    );
    ...
    public Component copyWithStyle(Holder<TrimMaterial> p_371533_) {
        return this.description.copy().withStyle(p_371533_.value().description().getStyle());
    }
}
