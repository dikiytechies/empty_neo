...
public class Squid extends AgeableWaterCreature {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_364995_, AgeableMob p_364552_) {
        return EntityType.SQUID.create(p_364995_, EntitySpawnReason.BREEDING);
    }
    ...
    @Override
    public boolean hurtServer(ServerLevel p_376152_, DamageSource p_376463_, float p_376746_) {
        if (super.hurtServer(p_376152_, p_376463_, p_376746_) && this.getLastHurtByMob() != null) {
            this.spawnInk();
            return true;
        } else {
            return false;
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_363110_, DifficultyInstance p_360622_, EntitySpawnReason p_360451_, @Nullable SpawnGroupData p_364007_
    ) {
        SpawnGroupData spawngroupdata = Objects.requireNonNullElseGet(p_364007_, () -> new AgeableMob.AgeableMobGroupData(0.05F));
        return super.finalizeSpawn(p_363110_, p_360622_, p_360451_, spawngroupdata);
    }
