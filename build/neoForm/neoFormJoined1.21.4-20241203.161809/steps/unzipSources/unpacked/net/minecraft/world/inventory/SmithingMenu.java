...
public class SmithingMenu extends ItemCombinerMenu {
    ...
    private SmithingMenu(int p_379902_, Inventory p_379577_, ContainerLevelAccess p_379989_, Level p_379924_) {
        super(MenuType.SMITHING, p_379902_, p_379577_, p_379989_, createInputSlotDefinitions(p_379924_.recipeAccess()));
    ...
    private static ItemCombinerMenuSlotDefinition createInputSlotDefinitions(RecipeAccess p_379456_) {
        RecipePropertySet recipepropertyset = p_379456_.propertySet(RecipePropertySet.SMITHING_BASE);
        RecipePropertySet recipepropertyset1 = p_379456_.propertySet(RecipePropertySet.SMITHING_TEMPLATE);
        RecipePropertySet recipepropertyset2 = p_379456_.propertySet(RecipePropertySet.SMITHING_ADDITION);
