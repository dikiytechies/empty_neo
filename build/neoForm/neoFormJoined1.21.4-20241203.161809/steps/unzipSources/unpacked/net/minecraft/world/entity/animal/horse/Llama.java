...
public class Llama extends AbstractChestedHorse implements VariantHolder<Llama.Variant>, RangedAttackMob {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_30774_, DifficultyInstance p_30775_, EntitySpawnReason p_364775_, @Nullable SpawnGroupData p_30777_
    ) {
        ...
        return super.finalizeSpawn(p_30774_, p_30775_, p_364775_, p_30777_);
    }
    ...
    @Override
    protected void followMommy(ServerLevel p_376423_) {
        if (!this.inCaravan() && this.isBaby()) {
            super.followMommy(p_376423_);
        }
    }
    ...
    static class LlamaAttackWolfGoal extends NearestAttackableTargetGoal<Wolf> {
        public LlamaAttackWolfGoal(Llama p_30843_) {
            super(p_30843_, Wolf.class, 16, false, true, (p_379168_, p_379169_) -> !((Wolf)p_379168_).isTame());
        }
