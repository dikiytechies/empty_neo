...
public class Zoglin extends Monster implements HoglinBase {
    ...
    private Optional<? extends LivingEntity> findNearestValidAttackTarget(ServerLevel p_376132_) {
        return this.getBrain()
            .getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
            .orElse(NearestVisibleLivingEntities.empty())
            .findClosest(p_376735_ -> this.isTargetable(p_376132_, p_376735_));
    }

    private boolean isTargetable(ServerLevel p_376303_, LivingEntity p_34253_) {
        EntityType<?> entitytype = p_34253_.getType();
        return entitytype != EntityType.ZOGLIN && entitytype != EntityType.CREEPER && Sensor.isEntityAttackable(p_376303_, this, p_34253_);
    }
