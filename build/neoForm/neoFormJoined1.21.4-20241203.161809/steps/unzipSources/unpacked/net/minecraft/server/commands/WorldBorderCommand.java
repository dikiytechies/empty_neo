                        ...
                        .then(
                            Commands.argument("distance", DoubleArgumentType.doubleArg(-5.999997E7F, 5.999997E7F))
                                .executes(
                                    p_379037_ -> setSize(
                                            p_379037_.getSource(),
                                            p_379037_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_379037_, "distance"),
                                            0L
                                        )
                                )
                                .then(
                                    Commands.argument("time", IntegerArgumentType.integer(0))
                                        .executes(
                                            p_379038_ -> setSize(
                                                    p_379038_.getSource(),
                                                    p_379038_.getSource().getLevel().getWorldBorder().getSize()
                                                        + DoubleArgumentType.getDouble(p_379038_, "distance"),
                                                    p_379038_.getSource().getLevel().getWorldBorder().getLerpRemainingTime()
                                                        + (long)IntegerArgumentType.getInteger(p_379038_, "time") * 1000L
                                                )
                                        )
                                )
                        )
